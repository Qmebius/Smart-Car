...
//		debug_send(data,4);
		...
		Car.Xdistance = ( Motor[0].distance - Motor[1].distance + Motor[2].distance - Motor[3].distance)/4 * 0.91;
...
void GyroW_Control(void)
{
	...
	float kp2 = 0.3f,ki2= 0.0f,kd2 = 2.5f;
...
void Correct_velocity(void)
{
	...
	{
		if(sqrt(pow(Car.distance_target[4],2) + pow(Car.distance_target[5],2)) > 4300)
		{
			k = 0.11;
			rate1 = 0.2;
			rate2 = 0.3;
		}
		else if(sqrt(pow(Car.distance_target[4],2) + pow(Car.distance_target[5],2)) > 2500)
		{
			k = 0.15;
			rate1 = 0.2;
			rate2 = 0.3;			
...
////		rate = 0.1;
//	}
//	if(sqrt(pow(Car.distance_target[0],2) + pow(Car.distance_target[1],2)) >4000)
//	{
//		PeakSpeed = 50;
//		rate = 0.15;
//		time = 0.1;
//	}
//	else if(sqrt(pow(Car.distance_target[4],2) + pow(Car.distance_target[5],2)) >3000)
//	{
//		PeakSpeed = 50;
//		rate = 0.13;
//		time = 0.2;	
...
//			time = 0.15;		
//		}
//		else if(sqrt(pow(Car.distance_target[0],2) + pow(Car.distance_target[1],2)) > 3000)
//		{
//			PeakSpeed = 50;
//			rate = 0.15;
//			time = 0.1;		
...
//	
//	}
//	if(abs(Car.distance_target[4]) == 0)
//	{
//		PeakSpeed = 50;
//		rate = 0.2;
//		time = 0.2;		
...
//		PeakSpeed = 120;
//	}
//	if(sqrt(pow(Car.distance_target[4],2) + pow(Car.distance_target[5],2)) <=600)
//	{
//		baseVelocity = 60;
//	}
//	else
